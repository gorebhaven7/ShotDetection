...
class InteractiveMediaPlayer(QWidget):
    def __init__(self, video_path, audio_path,json_file_name):
        ...
        json_file = open(os.path.join(dirname,'dict_of_start_times.json'))
    ...
    def setup_ui(self):
        ...
        # path = "/Users/bhavengore/Desktop/Multimedia/Project/Project-Multimedia/VideoPlayer/Data/"+sys.argv[1]
...
if __name__ == "__main__":
    ...
    video_path = os.path.join(dirname, 'Data', video)

    app = QApplication(sys.argv)
    window = InteractiveMediaPlayer(video_path, audio_path,json_file_name='dict_of_start_times.json')
